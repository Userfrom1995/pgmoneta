...
BuildRequires: liburing-devel openssl openssl-devel systemd systemd-devel libssh libssh-devel libarchive libarchive-devel
Requires:      liburing openssl systemd zlib libzstd lz4 bzip2 libssh libarchive
